...
public class BlockRoadSideLine extends Block {
	private IIcon[] icons = new IIcon[12];
	private IIcon other;

	public BlockRoadSideLine() {
		super(Material.rock);
		this.setBlockName("roadSideLine");
	...
	public void registerBlockIcons(IIconRegister register) {
		for (int i = 0; i < this.icons.length; i++) {
			this.icons[i] = register.registerIcon("digcraft:roadSideLine_" + i);
		}
