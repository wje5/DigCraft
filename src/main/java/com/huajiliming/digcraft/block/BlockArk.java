...
public class BlockArk extends BlockContainer {
	public BlockArk() {
		super(Material.wood);
		this.setHardness(1.0F);
		this.setBlockName("ark");
		this.setBlockTextureName("digcraft:ark");
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float xPos,
		...
		player.openGui(DigCraft.instance, GuiElementLoader.GUI_ARK, world, x, y, z);
		return true;
	}
