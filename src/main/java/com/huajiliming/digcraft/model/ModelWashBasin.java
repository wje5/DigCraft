...
public class ModelWashBasin extends ModelBase {
	private final ModelRenderer bone;

	public ModelWashBasin() {
		textureWidth = 128;
		textureHeight = 128;
		...
		bone.cubeList.add(new ModelBox(bone, 0, 35, -8.0F, -7.0F, -8.0F, 2, 3, 13, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 30, 35, 22.0F, -7.0F, -8.0F, 2, 3, 13, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 0, 4, 8.0F, -10.0F, 7.0F, 1, 3, 1, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 47, 37, 8.0F, -10.0F, 1.0F, 1, 1, 6, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 0, 9, 8.0F, -9.0F, 1.0F, 1, 1, 1, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 4, 4, 11.0F, -9.0F, 6.0F, 1, 2, 1, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 7, 7, 11.0F, -9.0F, 5.0F, 1, 1, 1, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 3, 7, 5.0F, -9.0F, 6.0F, 1, 2, 1, 0.0F));
		bone.cubeList.add(new ModelBox(bone, 8, 4, 5.0F, -9.0F, 5.0F, 1, 1, 1, 0.0F));
		...
		bone.cubeList.add(new ModelBox(bone, 0, 27, -6.0F, -4.0F, -7.0F, 28, 2, 2, 0.0F));
	}
