...
public class GuiContainerAmbry extends GuiContainer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("digcraft:textures/gui/container/ambry.png");
	protected ContainerAmbry container;

	public GuiContainerAmbry(ContainerAmbry container) {
		super(container);
		this.xSize = 176;
		this.ySize = 166;
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		String title = I18n.format("container.ambry", new Object[0]);
